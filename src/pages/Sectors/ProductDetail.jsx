  ...
  return (
    <div className="min-h-screen bg-white p-8">
      ...
      <section className="mt-8">
        ...
        <p>For more information, please reach out to our investment support team at <a href="mailto:support@investment.com" className="text-blue-500 hover:underline">support@investment.com</a>.</p>
      </section>
    </div>
  );
};
