...
const Education = () => {
  ...
  const [selectedSector, setSelectedSector] = useState("Industrial");
  ...
  return (
    <div className="min-h-screen bg-white p-8">
      <h1 className="text-3xl font-semibold mb-4">Industry Investments</h1>
      <p>Invest in Industrial innovations</p>
