...
const Education = () => {
  ...
  const [selectedSector, setSelectedSector] = useState("Clothing");
  ...
  return (
    <div className="min-h-screen bg-white p-8">
      <h1 className="text-3xl font-semibold mb-4">Clothing Investments</h1>
      <p>Invest in Food and Beverages</p>
